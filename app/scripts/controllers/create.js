...
angular.module('messageFactoryApp')
  .controller('CreateCtrl', ['$scope', '$window', '$location', '$timeout', '$filter', 'config_ui', 'POAPIService', function ($scope, $window, $location, $timeout, $filter, config_ui, POAPIService) {
