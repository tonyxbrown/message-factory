...
angular.module('messageFactoryApp')
  .controller('ExportCtrl', ['$scope', '$window', '$location', '$timeout', '$filter', 'config_ui', 'POAPIService', function ($scope, $window, $location, $timeout, $filter, config_ui, POAPIService) {
