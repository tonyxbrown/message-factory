 ...
 * @description
 * # MessagesCtrl
 * Controller of the poWebApp
 */
angular.module('messageFactoryApp')
  .controller('MessagesCtrl', ['$scope', '$window', '$location', 'config_ui', '$timeout', 'POAPIService', function ($scope, $window, $location, config_ui, $timeout, POAPIService) {
